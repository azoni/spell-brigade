...
export const ENEMY_TYPES = {
  ...
  // ZONE BOSSES - Unique per zone with multi-phase attacks
  boss_meadow: {
    id: 'boss_meadow',
    ...
    zone: 'meadow',
    attackCooldown: 2500,
    attacks: ['spore_burst', 'vine_sweep', 'pollen_cloud'],
  },
  boss_forest: {
    id: 'boss_forest',
    name: 'Ancient Treant',
    ...
    zone: 'forest',
    attackCooldown: 3000,
    attacks: ['root_trap', 'branch_slam', 'summon_saplings'],
  },
  boss_volcanic: {
    id: 'boss_volcanic',
    name: 'Magma Titan',
    ...
    zone: 'volcanic',
    attackCooldown: 3500,
    attacks: ['meteor_rain', 'lava_slam', 'eruption'],
  },
  boss_frozen: {
    id: 'boss_frozen',
    name: 'Frost Wyrm',
    ...
    zone: 'frozen',
    attackCooldown: 3000,
    attacks: ['ice_breath', 'blizzard_ring', 'glacial_charge'],
  },
  boss_abyss: {
    id: 'boss_abyss',
    name: 'Void Overlord',
    ...
    zone: 'abyss',
    attackCooldown: 2500,
    attacks: ['void_pulse', 'shadow_orbs', 'dimension_rip', 'summon_shades'],
  },
  boss_crystal: {
    id: 'boss_crystal',
    name: 'Crystal Golem',
    ...
    zone: 'crystal_caves',
    attackCooldown: 2800,
    attacks: ['crystal_barrage', 'prism_beam', 'shatter_stomp'],
  },
